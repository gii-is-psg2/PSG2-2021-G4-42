...
/**
 * Spring Data JPA specialization of the {@link HabitacionRepository} interface
 *
 * @author Michael Isvy
 * @since 15.1.2013
 */
public interface HabitacionRepository extends Repository<Habitacion, Integer> {
	...
	Optional<Habitacion> findHabitacionByNumero(Integer numero) throws DataAccessException;
